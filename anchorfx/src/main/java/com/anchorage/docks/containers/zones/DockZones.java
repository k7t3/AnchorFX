...
public final class DockZones extends Stage {
    ...
    static {
        dragTopImage = new Image("/anchorfx/dragtop.png");
        dragBottomImage = new Image("/anchorfx/dragbottom.png");
        dragLeftImage = new Image("/anchorfx/dragleft.png");
        dragRightImage = new Image("/anchorfx/dragright.png");
        dragCenterImage = new Image("/anchorfx/dragcenter.png");
    }
